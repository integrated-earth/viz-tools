  ...
  function onReady(sceneImporter) {
    sceneImporter.onReady(() => {
      ...
      const diagonal = Math.sqrt(
        ...
        camera.set({ position: [centerX, centerY - distance, centerZ + 0.2*distance], focalPoint: [centerX, centerY, centerZ] });
        ...
        scene=sceneImporter.getScene();//.getRootActors()[0];
        const n_actors = scene.length;
        ...
        commonCenter[0] /= n_actors;
        commonCenter[1] /= n_actors;
        commonCenter[2] /= n_actors;
        scene.forEach((actor) => {
        ...
        let cr=camera.getClippingRange();
        console.log(cr);
